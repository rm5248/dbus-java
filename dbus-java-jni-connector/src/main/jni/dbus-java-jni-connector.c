...
#include "com_github_hypfvieh_dbus_java_jni_connector_NativeMessageReader.h"
#include "jni_utils.h"
...
/*
 * Class:     com_github_hypfvieh_dbus_java_jni_connector_NativeMessageReader
 * Method:    openNativeHandle
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_github_hypfvieh_dbus_java_jni_connector_NativeMessageReader_openNativeHandle
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_github_hypfvieh_dbus_java_jni_connector_NativeMessageReader_closeNativeHandle
 ...
 * Class:     com_github_hypfvieh_dbus_java_jni_connector_NativeMessageReader
 * Method:    readNative
 * Signature: (I)Lcom/github/hypfvieh/dbus/java/jni/connector/MsgHdr;
 */
JNIEXPORT jobject JNICALL Java_com_github_hypfvieh_dbus_java_jni_connector_NativeMessageReader_readNative
  (JNIEnv * env, jobject obj, jint handle){
	struct ReceiveHandle* rx_handle = rx_array[ handle ];
	ssize_t ret;
	...
	jniutil_slf4j_log( env,
		"org/freedesktop/dbus/jniconnector/NativeMessageReader",
		"logger_native",
		SLF4J_DEBUG,
	...
	msghdr_class = (*env)->FindClass( env, "org/freedesktop/dbus/jniconnector/MsgHdr" );
	constructor_id = (*env)->GetMethodID( env, msghdr_class, "<init>", "([B,[I)V" );
	//fd_array = (*env)->NewIntArray( env, );
